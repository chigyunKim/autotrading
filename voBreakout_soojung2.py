...
def get_current_cash():
    ...
    cpCash.BlockRequest()
    return cpCash.GetHeaderValue(45) + cpCash.GetHeaderValue(51)  # 증거금 100% 주문 가능 금액
...
def get_target_price(code):
    ...
    try:
        ...
        target_price = today_open + (lastday_high - lastday_open) * 0
        return target_price
...
def buy_etf(code):
    ...
    try:
        ...
        if current_price > target_price:
            ...
            printlog('최유리 매수 ->', stock_name, code, buy_qty, '->', ret)
            if ret == 4:
